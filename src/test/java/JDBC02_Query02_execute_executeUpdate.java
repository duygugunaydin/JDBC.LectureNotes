...
public class JDBC02_Query02_execute_executeUpdate {
    ...
    */
        ...
        //System.out.println(st.execute(dropQuery));// bu satır ıle alttaki satır aynı islemi yapıyor.
        if (!st.execute(dropQuery)){                // ikisinden biri yorumda olmalı.
